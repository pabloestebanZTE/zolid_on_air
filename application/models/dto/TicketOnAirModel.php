...
class TicketOnAirModel extends Model {
    ...
    protected $n_atribuible_nokia__;
    protected $n_kpis_degraded__;
    ...
    protected $n_implementacion_campo__;
    protected $n_doc__;
    protected $n_gestion_power__;
    protected $n_obra_civil__;
    protected $on_air__;
    protected $fecha_rft__;
    protected $d_fecha_cg;
    protected $n_exclusion_bajo_trafico__;
    protected $n_ticket__;
    protected $n_estado_ticket__;
    protected $n_sln_modernizacion__;
